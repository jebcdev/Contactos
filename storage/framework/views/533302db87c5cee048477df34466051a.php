            ...
            <?php $__currentLoopData = $contacts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td>
                        ...
                        href="<?php echo e(route('contacts.show', $contact->id)); ?>"
                        ><?php echo e($contact->dni); ?></a>
                        </td>
                    <td><?php echo e($contact->name); ?></td>
                    <td><?php echo e($contact->surname); ?></td>
                    <td><?php echo e($contact->phone); ?></td>
                    <td>
                        <a class="btn btn-secondary" href="<?php echo e(route('contacts.show', $contact)); ?>">
                            Ver
                        </a>

                        <a class="btn btn-secondary" href="<?php echo e(route('contacts.edit', $contact)); ?>">
                            Editar
                        </a>
